...
namespace CollectorsClub.Model.Commands {
	...
	public partial class CreateOrUpdateEstadoCalendarioCommand : ICommand {
			public short Id { get; set; }
			public string Nombre { get; set; }
			public string Codigo { get; set; }
			public string IdMarca { get; set; }
			public ICollection<CreateOrUpdateCalendarioCommand> Calendarios { get; set; }
			public ICollection<CreateOrUpdateEstadoCalendario_IdiomaCommand> RegistrosIdiomas { get; set; }
