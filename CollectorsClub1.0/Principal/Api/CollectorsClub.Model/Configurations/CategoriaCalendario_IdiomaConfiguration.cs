...
namespace CollectorsClub.Model.Configurations {
	public partial class CategoriaCalendario_IdiomaConfiguration : EntityTypeConfiguration<CategoriaCalendario_Idioma> {
		public CategoriaCalendario_IdiomaConfiguration() {
			ToTable("CategoriasCalendario_Idiomas");
			HasKey(p => new { p.Id });
