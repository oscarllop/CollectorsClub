...
namespace CollectorsClub.Model.Configurations {
	public partial class EstadoCalendario_IdiomaConfiguration : EntityTypeConfiguration<EstadoCalendario_Idioma> {
		public EstadoCalendario_IdiomaConfiguration() {
			ToTable("EstadosCalendario_Idiomas");
			HasKey(p => new { p.Id });
