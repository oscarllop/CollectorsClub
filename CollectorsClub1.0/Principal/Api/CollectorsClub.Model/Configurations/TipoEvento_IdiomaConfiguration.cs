...
namespace CollectorsClub.Model.Configurations {
	public partial class TipoEvento_IdiomaConfiguration : EntityTypeConfiguration<TipoEvento_Idioma> {
		public TipoEvento_IdiomaConfiguration() {
			ToTable("TiposEvento_Idiomas");
			HasKey(p => new { p.Id });
