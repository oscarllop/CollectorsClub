<%@ control language="C#" inherits="CollectorsClub.Modules.Editores.EditorTipoEvento_Idioma.View" autoeventwireup="true" codefile="TipoEvento_IdiomaEditorView.ascx.cs" enableviewstate="false" %>
<asp:panel runat="server" id="Container">
	...
	<div id="TipoEvento_IdiomaEditorPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="TipoEvento_IdiomaEditorPrincipalContenedorExterno"></div>
	<div id="TipoEvento_IdiomaEditorPrincipalContenedorExterno" style="display: block;" data-bind="partial: Parametros"></div>
	<script type="text/javascript">
		if (typeof window.ParametrosGlobales === 'undefined') {
			window.ParametrosGlobales = {
				MostrarErrores: true,
				ErrorContainer: 'ErrorContainer',
				//ContenedorModulo: 'TipoEvento_IdiomaEditorPrincipalContenedorExterno',
				//ElementoReferenciaCargando: 'TipoEvento_IdiomaEditorPrincipalContenedorExterno',
				//CapaBloqueoCargando: 'TipoEvento_IdiomaEditorPrincipalContenedorCargando',
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'TipoEvento_IdiomaEditor',
					Entidad: 'TipoEvento_Idioma',
					IdPartial: 'TipoEvento_IdiomaEditorPrincipal',
					Contenedor: '#TipoEvento_IdiomaEditorPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				ko.applyBindings({ Parametros: _parametros }, $('#TipoEvento_IdiomaEditorPrincipalContenedorExterno')[0]);
