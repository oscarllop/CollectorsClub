<%@ control language="C#" inherits="CollectorsClub.Modules.Editores.EditorEvento.View" autoeventwireup="true" codefile="EventoEditorView.ascx.cs" enableviewstate="false" %>
<asp:panel runat="server" id="Container">
	...
	<div id="EventoEditorPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="EventoEditorPrincipalContenedorExterno"></div>
	<div id="EventoEditorPrincipalContenedorExterno" style="display: block;" data-bind="partial: Parametros"></div>
	<script type="text/javascript">
		if (typeof window.ParametrosGlobales === 'undefined') {
			window.ParametrosGlobales = {
				MostrarErrores: true,
				ErrorContainer: 'ErrorContainer',
				//ContenedorModulo: 'EventoEditorPrincipalContenedorExterno',
				//ElementoReferenciaCargando: 'EventoEditorPrincipalContenedorExterno',
				//CapaBloqueoCargando: 'EventoEditorPrincipalContenedorCargando',
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'EventoEditor',
					Entidad: 'Evento',
					IdPartial: 'EventoEditorPrincipal',
					Contenedor: '#EventoEditorPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				var _parametrosUrl = ['IdDesde', 'IdHasta', 'IdTipo', 'Activa', 'Nombre', 'FechaDesde', 'FechaHasta', 'HoraInicioDesde', 'HoraInicioHasta', 'HoraFinDesde', 'HoraFinHasta', 'Ubicacion', 'Descripcion', 'FechaAltaDesde', 'FechaAltaHasta', 'FechaUltimaModificacionDesde', 'FechaUltimaModificacionHasta', 'Cultura', 'IdMarca'];
				var _filtro = {};
				...
				ko.applyBindings({ Parametros: _parametros }, $('#EventoEditorPrincipalContenedorExterno')[0]);
