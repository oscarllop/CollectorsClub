define(['Globales/BaseViewModelEditor', 'knockout', 'global/knockout/knockout.validation.min', 'Globales/ko.observableDictionary', 'WebAPI/Controllers/Video_IdiomaController', 'WebAPI/Models/Video_IdiomaModel', 'WebAPI/Controllers/VideoController', 'WebAPI/Models/VideoModel', 'Globales/Core.Utils', 'Globales/popup', 'moment/moment-with-locales.min'], function (baseViewModel, ko, validation, observableDictionary, Video_IdiomaController, Video_IdiomaModel, VideoController, VideoModel, utils, popup, moment) {
	try {
		return function Video_IdiomaEditorViewModel(settings) {
			var self = this;
			self.settings = $.extend({}, settings);
			// #region Propiedades y métodos que difieren por entidad
			self.Entidad = 'Video_Idioma';
			self.CamposVisiblesInsercion = { Id: true, IdRegistro: true, Nombre: true, Descripcion: true, Url: true, Cultura: true };
			self.CamposVisiblesEdicion = { Id: true, IdRegistro: true, Nombre: true, Descripcion: true, Url: true, Cultura: true };
			self.CamposHabilitadosInsercion = { Id: false, IdRegistro: true, Nombre: true, Descripcion: true, Url: true, Cultura: true };
			self.CamposHabilitadosEdicion = { Id: false, IdRegistro: true, Nombre: true, Descripcion: true, Url: true, Cultura: true };
			self.CamposHabilitadosFiltro = { Id: true, IdRegistro: true, Nombre: true, Descripcion: true, Url: true, Cultura: true };
			...
			self.EntidadesRelacionadas = ['Video'];
			...
			self.MetodoObtenerPorFiltros = 'Video_Idioma_ObtenerPorFiltros';
			self.MetodoObtenerCantidadPorFiltros = 'Video_Idioma_ObtenerCantidadPorFiltros';
			...
			self.New = function () { baseViewModel.New(self, Video_IdiomaModel); };
			...
			self.Inicializar = function (settings) { baseViewModel.Inicializar(self, settings, Video_IdiomaModel); };
			...
			self.MostrarDialogoCopia = function (viewModel) { baseViewModel.MostrarDialogoCopia(viewModel, Video_IdiomaModel); };
			...
			self.MostrarDialogoEdicionMultiple = function (viewModel) { baseViewModel.MostrarDialogoEdicionMultiple(viewModel, Video_IdiomaModel); };
			...
			if (typeof (GlobalControllers) != 'undefined' && typeof (GlobalControllers['Video_IdiomaController']) == 'undefined') { GlobalControllers['Video_IdiomaController'] = new Video_IdiomaController(settings); }
			...
			self.Videos = ko.lazyObservableArray(GlobalControllers['VideoController'].GetQuery, self, {
				Todos: true,
				Parameters: 'query=Video_ObtenerComboPorIdMarca' +
			...
			baseViewModel.InicializarViewModel(self, settings, Video_IdiomaModel);
		};
	} catch (excepcion) {
