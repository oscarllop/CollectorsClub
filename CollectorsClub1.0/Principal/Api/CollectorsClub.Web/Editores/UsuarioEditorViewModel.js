define(['Globales/BaseViewModelEditor', 'knockout', 'global/knockout/knockout.validation.min', 'Globales/ko.observableDictionary', 'WebAPI/Controllers/UsuarioController', 'WebAPI/Models/UsuarioModel', 'WebAPI/Controllers/MarcaController', 'WebAPI/Models/MarcaModel', 'Globales/Core.Utils', 'Globales/popup', 'moment/moment-with-locales.min'], function (baseViewModel, ko, validation, observableDictionary, UsuarioController, UsuarioModel, MarcaController, MarcaModel, utils, popup, moment) {
	try {
		return function UsuarioEditorViewModel(settings) {
			var self = this;
			self.settings = $.extend({}, settings);
			// #region Propiedades y métodos que difieren por entidad
			self.Entidad = 'Usuario';
			self.CamposVisiblesInsercion = { Id: true, Nombre: true, PrimerApellido: true, SegundoApellido: true, NombreDeUsuario: true, CorreoElectronico: true };
			self.CamposVisiblesEdicion = { Id: true, Nombre: true, PrimerApellido: true, SegundoApellido: true, NombreDeUsuario: true, CorreoElectronico: true };
			self.CamposHabilitadosInsercion = { Id: false, Nombre: true, PrimerApellido: true, SegundoApellido: true, NombreDeUsuario: true, CorreoElectronico: true };
			self.CamposHabilitadosEdicion = { Id: false, Nombre: true, PrimerApellido: true, SegundoApellido: true, NombreDeUsuario: true, CorreoElectronico: true };
			self.CamposHabilitadosFiltro = { Id: true, Nombre: true, PrimerApellido: true, SegundoApellido: true, NombreDeUsuario: true, CorreoElectronico: true, IdMarca: true };
			...
			self.MetodoObtenerPorFiltros = 'Usuario_ObtenerPorFiltros';
			self.MetodoObtenerCantidadPorFiltros = 'Usuario_ObtenerCantidadPorFiltros';
			...
			self.ObtenerFiltros = function (filtro) {
				return '&parameter=IdDesde|int|' + (typeof (filtro.IdDesde) !== 'undefined' && filtro.IdDesde !== null ? filtro.IdDesde : '') +
					...
					'&parameter=PrimerApellido|nvarchar|' + (typeof (filtro.PrimerApellido) !== 'undefined' && filtro.PrimerApellido !== null ? filtro.PrimerApellido : '') + '|50' +
					'&parameter=SegundoApellido|nvarchar|' + (typeof (filtro.SegundoApellido) !== 'undefined' && filtro.SegundoApellido !== null ? filtro.SegundoApellido : '') + '|50' +
					'&parameter=NombreDeUsuario|nvarchar|' + (typeof (filtro.NombreDeUsuario) !== 'undefined' && filtro.NombreDeUsuario !== null ? filtro.NombreDeUsuario : '') + '|150' +
			...
			self.New = function () { baseViewModel.New(self, UsuarioModel); };
			...
			self.Inicializar = function (settings) { baseViewModel.Inicializar(self, settings, UsuarioModel); };
			...
			self.MostrarDialogoCopia = function (viewModel) { baseViewModel.MostrarDialogoCopia(viewModel, UsuarioModel); };
			...
			self.MostrarDialogoEdicionMultiple = function (viewModel) { baseViewModel.MostrarDialogoEdicionMultiple(viewModel, UsuarioModel); };
			...
			baseViewModel.InicializarViewModel(self, settings, UsuarioModel);
		};
	} catch (excepcion) {
