<%@ control language="C#" inherits="CollectorsClub.Modules.Editores.EditorCategoriaCalendario.View" autoeventwireup="true" codefile="CategoriaCalendarioEditorView.ascx.cs" enableviewstate="false" %>
<asp:panel runat="server" id="Container">
	...
	<div id="CategoriaCalendarioEditorPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="CategoriaCalendarioEditorPrincipalContenedorExterno"></div>
	<div id="CategoriaCalendarioEditorPrincipalContenedorExterno" style="display: block;" data-bind="partial: Parametros"></div>
	<script type="text/javascript">
		if (typeof window.ParametrosGlobales === 'undefined') {
			window.ParametrosGlobales = {
				MostrarErrores: true,
				ErrorContainer: 'ErrorContainer',
				//ContenedorModulo: 'CategoriaCalendarioEditorPrincipalContenedorExterno',
				//ElementoReferenciaCargando: 'CategoriaCalendarioEditorPrincipalContenedorExterno',
				//CapaBloqueoCargando: 'CategoriaCalendarioEditorPrincipalContenedorCargando',
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'CategoriaCalendarioEditor',
					Entidad: 'CategoriaCalendario',
					IdPartial: 'CategoriaCalendarioEditorPrincipal',
					Contenedor: '#CategoriaCalendarioEditorPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				ko.applyBindings({ Parametros: _parametros }, $('#CategoriaCalendarioEditorPrincipalContenedorExterno')[0]);
