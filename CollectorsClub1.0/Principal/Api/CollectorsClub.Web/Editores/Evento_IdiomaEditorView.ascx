<%@ control language="C#" inherits="CollectorsClub.Modules.Editores.EditorEvento_Idioma.View" autoeventwireup="true" codefile="Evento_IdiomaEditorView.ascx.cs" enableviewstate="false" %>
<asp:panel runat="server" id="Container">
	...
	<div id="Evento_IdiomaEditorPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="Evento_IdiomaEditorPrincipalContenedorExterno"></div>
	<div id="Evento_IdiomaEditorPrincipalContenedorExterno" style="display: block;" data-bind="partial: Parametros"></div>
	<script type="text/javascript">
		if (typeof window.ParametrosGlobales === 'undefined') {
			window.ParametrosGlobales = {
				MostrarErrores: true,
				ErrorContainer: 'ErrorContainer',
				//ContenedorModulo: 'Evento_IdiomaEditorPrincipalContenedorExterno',
				//ElementoReferenciaCargando: 'Evento_IdiomaEditorPrincipalContenedorExterno',
				//CapaBloqueoCargando: 'Evento_IdiomaEditorPrincipalContenedorCargando',
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'Evento_IdiomaEditor',
					Entidad: 'Evento_Idioma',
					IdPartial: 'Evento_IdiomaEditorPrincipal',
					Contenedor: '#Evento_IdiomaEditorPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				var _parametrosUrl = ['IdDesde', 'IdHasta', 'IdRegistro', 'Cultura', 'Ubicacion', 'Nombre', 'Descripcion'];
				var _filtro = {};
				...
				ko.applyBindings({ Parametros: _parametros }, $('#Evento_IdiomaEditorPrincipalContenedorExterno')[0]);
