define(['Globales/BaseSystem', 'Globales/Core.Utils', 'partials/TipoEvento_IdiomaEditorViewModel', 'use!porto/js/skin'], function (baseSystem, utils, viewModel, skin) {
	try {
		return function TipoEvento_IdiomaEditorSystem($, ko, settings) {
			var self = this;
			...
			self.Repositorio = {};
			self.ViewModel;
			self.RutaRecursos = self.settings.ApplicationPath + '/DesktopModules/_extension/Recursos.aspx?Ruta=DesktopModules__CollectorsClub__Editores__App_LocalResources&Modulo=TipoEvento_IdiomaEditorView';
