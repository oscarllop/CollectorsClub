define(['Globales/BaseSystem', 'Globales/Core.Utils', 'partials/SolicitudContactoEditorViewModel', 'use!porto/js/skin', 'ParametrosGlobales', 'dojo/order!Plugins/ckeditor/ckeditor'], function (baseSystem, utils, viewModel, skin, parametrosGlobales, ckeditor) {
	try {
		return function SolicitudContactoEditorSystem($, ko, settings) {
			var self = this;
			...
			self.Repositorio = {};
			self.ViewModel;
			self.RutaRecursos = self.settings.ApplicationPath + '/DesktopModules/_extension/Recursos.aspx?Ruta=DesktopModules__CollectorsClub__Editores__App_LocalResources&Modulo=SolicitudContactoEditorView';
