<%@ control language="C#" inherits="CollectorsClub.Modules.Editores.EditorTipoColeccionCalendario_Idioma.View" autoeventwireup="true" codefile="TipoColeccionCalendario_IdiomaEditorView.ascx.cs" enableviewstate="false" %>
<asp:panel runat="server" id="Container">
	...
	<div id="TipoColeccionCalendario_IdiomaEditorPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="TipoColeccionCalendario_IdiomaEditorPrincipalContenedorExterno"></div>
	<div id="TipoColeccionCalendario_IdiomaEditorPrincipalContenedorExterno" style="display: block;" data-bind="partial: Parametros"></div>
	<script type="text/javascript">
		if (typeof window.ParametrosGlobales === 'undefined') {
			window.ParametrosGlobales = {
				MostrarErrores: true,
				ErrorContainer: 'ErrorContainer',
				//ContenedorModulo: 'TipoColeccionCalendario_IdiomaEditorPrincipalContenedorExterno',
				//ElementoReferenciaCargando: 'TipoColeccionCalendario_IdiomaEditorPrincipalContenedorExterno',
				//CapaBloqueoCargando: 'TipoColeccionCalendario_IdiomaEditorPrincipalContenedorCargando',
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					Entidad: 'TipoColeccionCalendario_Idioma',
					IdPartial: 'TipoColeccionCalendario_IdiomaEditorPrincipal',
					Contenedor: '#TipoColeccionCalendario_IdiomaEditorPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				ko.applyBindings({ Parametros: _parametros }, $('#TipoColeccionCalendario_IdiomaEditorPrincipalContenedorExterno')[0]);
