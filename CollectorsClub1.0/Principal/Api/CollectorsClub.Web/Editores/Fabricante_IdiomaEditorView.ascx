<%@ control language="C#" inherits="CollectorsClub.Modules.Editores.EditorFabricante_Idioma.View" autoeventwireup="true" codefile="Fabricante_IdiomaEditorView.ascx.cs" enableviewstate="false" %>
<asp:panel runat="server" id="Container">
	...
	<div id="Fabricante_IdiomaEditorPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="Fabricante_IdiomaEditorPrincipalContenedorExterno"></div>
	<div id="Fabricante_IdiomaEditorPrincipalContenedorExterno" style="display: block;" data-bind="partial: Parametros"></div>
	<script type="text/javascript">
		if (typeof window.ParametrosGlobales === 'undefined') {
			window.ParametrosGlobales = {
				MostrarErrores: true,
				ErrorContainer: 'ErrorContainer',
				//ContenedorModulo: 'Fabricante_IdiomaEditorPrincipalContenedorExterno',
				//ElementoReferenciaCargando: 'Fabricante_IdiomaEditorPrincipalContenedorExterno',
				//CapaBloqueoCargando: 'Fabricante_IdiomaEditorPrincipalContenedorCargando',
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'Fabricante_IdiomaEditor',
					Entidad: 'Fabricante_Idioma',
					IdPartial: 'Fabricante_IdiomaEditorPrincipal',
					Contenedor: '#Fabricante_IdiomaEditorPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				ko.applyBindings({ Parametros: _parametros }, $('#Fabricante_IdiomaEditorPrincipalContenedorExterno')[0]);
