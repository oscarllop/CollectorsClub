define(['Globales/BaseViewModelEditor', 'knockout', 'global/knockout/knockout.validation.min', 'Globales/ko.observableDictionary', 'WebAPI/Controllers/Entidad_IdiomaController', 'WebAPI/Models/Entidad_IdiomaModel', 'WebAPI/Controllers/EntidadController', 'WebAPI/Models/EntidadModel', 'Globales/Core.Utils', 'Globales/popup', 'moment/moment-with-locales.min'], function (baseViewModel, ko, validation, observableDictionary, Entidad_IdiomaController, Entidad_IdiomaModel, EntidadController, EntidadModel, utils, popup, moment) {
	try {
		return function Entidad_IdiomaEditorViewModel(settings) {
			var self = this;
			self.settings = $.extend({}, settings);
			// #region Propiedades y métodos que difieren por entidad
			self.Entidad = 'Entidad_Idioma';
			...
			self.EntidadesRelacionadas = ['Entidad'];
			...
			self.MetodoObtenerPorFiltros = 'Entidad_Idioma_ObtenerPorFiltros';
			self.MetodoObtenerCantidadPorFiltros = 'Entidad_Idioma_ObtenerCantidadPorFiltros';
			...
			self.New = function () { baseViewModel.New(self, Entidad_IdiomaModel); };
			...
			self.Inicializar = function (settings) { baseViewModel.Inicializar(self, settings, Entidad_IdiomaModel); };
			...
			self.MostrarDialogoCopia = function (viewModel) { baseViewModel.MostrarDialogoCopia(viewModel, Entidad_IdiomaModel); };
			...
			self.MostrarDialogoEdicionMultiple = function (viewModel) { baseViewModel.MostrarDialogoEdicionMultiple(viewModel, Entidad_IdiomaModel); };
			...
			if (typeof (GlobalControllers) != 'undefined' && typeof (GlobalControllers['Entidad_IdiomaController']) == 'undefined') { GlobalControllers['Entidad_IdiomaController'] = new Entidad_IdiomaController(settings); }
			...
			baseViewModel.InicializarViewModel(self, settings, Entidad_IdiomaModel);
		};
	} catch (excepcion) {
