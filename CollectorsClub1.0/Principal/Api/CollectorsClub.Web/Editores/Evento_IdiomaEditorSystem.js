define(['Globales/BaseSystem', 'Globales/Core.Utils', 'partials/Evento_IdiomaEditorViewModel', 'use!porto/js/skin', 'ParametrosGlobales', 'dojo/order!Plugins/ckeditor/ckeditor'], function (baseSystem, utils, viewModel, skin, parametrosGlobales, ckeditor) {
	try {
		return function Evento_IdiomaEditorSystem($, ko, settings) {
			var self = this;
			...
			self.Repositorio = {};
			self.ViewModel;
			self.RutaRecursos = self.settings.ApplicationPath + '/DesktopModules/_extension/Recursos.aspx?Ruta=DesktopModules__CollectorsClub__Editores__App_LocalResources&Modulo=Evento_IdiomaEditorView';
