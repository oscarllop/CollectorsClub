            ...
            <table width="100%" cellpadding="5" >
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <input type="text" value="http://" data-ls="layer-Link" style="width: 500px" title="If you want to link your layer, type here the URL. You can use a hash mark followed by a number to link this layer to another slide. Example: #3 - this will switch to the third slide." />
                        </td>
                    </tr>
                    <tr>
                        <td>
