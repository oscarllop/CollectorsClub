<%@ control language="C#" inherits="CollectorsClub.Modules.Editores.EditorCalendario.View" autoeventwireup="true" codefile="CalendarioEditorView.ascx.cs" enableviewstate="false" %>
<asp:panel runat="server" id="Container">
	...
	<div id="CalendarioEditorPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="CalendarioEditorPrincipalContenedorExterno"></div>
	<div id="CalendarioEditorPrincipalContenedorExterno" style="display: block;" data-bind="partial: Parametros"></div>
	<script type="text/javascript">
		if (typeof window.ParametrosGlobales === 'undefined') {
			window.ParametrosGlobales = {
				MostrarErrores: true,
				ErrorContainer: 'ErrorContainer',
				//ContenedorModulo: 'CalendarioEditorPrincipalContenedorExterno',
				//ElementoReferenciaCargando: 'CalendarioEditorPrincipalContenedorExterno',
				//CapaBloqueoCargando: 'CalendarioEditorPrincipalContenedorCargando',
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'CalendarioEditor',
					Entidad: 'Calendario',
					IdPartial: 'CalendarioEditorPrincipal',
					Contenedor: '#CalendarioEditorPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				var _parametrosUrl = ['IdDesde', 'IdHasta', 'IdTipoColeccion', 'Visible', 'IdCategoria', 'IdSubcategoria', 'Imagen', 'Nombre', 'IdEstado', 'Anyo', 'IdEntidad', 'Serie', 'NumeroRepetidosDesde', 'NumeroRepetidosHasta', 'NumeroSerie', 'IdEntidadContratante', 'DL', 'Variante', 'IdFabricante', 'PaginaWeb', 'Codigo', 'IdUsuario', 'Cultura', 'IdMarca'];
				var _filtro = {};
				...
				ko.applyBindings({ Parametros: _parametros }, $('#CalendarioEditorPrincipalContenedorExterno')[0]);
