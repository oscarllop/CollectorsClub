<%@ control language="C#" inherits="CollectorsClub.Modules.Editores.EditorEstadoCalendario_Idioma.View" autoeventwireup="true" codefile="EstadoCalendario_IdiomaEditorView.ascx.cs" enableviewstate="false" %>
<asp:panel runat="server" id="Container">
	...
	<div id="EstadoCalendario_IdiomaEditorPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="EstadoCalendario_IdiomaEditorPrincipalContenedorExterno"></div>
	<div id="EstadoCalendario_IdiomaEditorPrincipalContenedorExterno" style="display: block;" data-bind="partial: Parametros"></div>
	<script type="text/javascript">
		if (typeof window.ParametrosGlobales === 'undefined') {
			window.ParametrosGlobales = {
				MostrarErrores: true,
				ErrorContainer: 'ErrorContainer',
				//ContenedorModulo: 'EstadoCalendario_IdiomaEditorPrincipalContenedorExterno',
				//ElementoReferenciaCargando: 'EstadoCalendario_IdiomaEditorPrincipalContenedorExterno',
				//CapaBloqueoCargando: 'EstadoCalendario_IdiomaEditorPrincipalContenedorCargando',
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'EstadoCalendario_IdiomaEditor',
					Entidad: 'EstadoCalendario_Idioma',
					IdPartial: 'EstadoCalendario_IdiomaEditorPrincipal',
					Contenedor: '#EstadoCalendario_IdiomaEditorPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				ko.applyBindings({ Parametros: _parametros }, $('#EstadoCalendario_IdiomaEditorPrincipalContenedorExterno')[0]);
