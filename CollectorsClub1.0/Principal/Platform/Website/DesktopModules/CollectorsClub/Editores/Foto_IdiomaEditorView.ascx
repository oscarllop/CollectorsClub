<%@ control language="C#" inherits="CollectorsClub.Modules.Editores.EditorFoto_Idioma.View" autoeventwireup="true" codefile="Foto_IdiomaEditorView.ascx.cs" enableviewstate="false" %>
<asp:panel runat="server" id="Container">
	...
	<div id="Foto_IdiomaEditorPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="Foto_IdiomaEditorPrincipalContenedorExterno"></div>
	<div id="Foto_IdiomaEditorPrincipalContenedorExterno" style="display: block;" data-bind="partial: Parametros"></div>
	<script type="text/javascript">
		if (typeof window.ParametrosGlobales === 'undefined') {
			window.ParametrosGlobales = {
				MostrarErrores: true,
				ErrorContainer: 'ErrorContainer',
				//ContenedorModulo: 'Foto_IdiomaEditorPrincipalContenedorExterno',
				//ElementoReferenciaCargando: 'Foto_IdiomaEditorPrincipalContenedorExterno',
				//CapaBloqueoCargando: 'Foto_IdiomaEditorPrincipalContenedorCargando',
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'Foto_IdiomaEditor',
					Entidad: 'Foto_Idioma',
					IdPartial: 'Foto_IdiomaEditorPrincipal',
					Contenedor: '#Foto_IdiomaEditorPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				var _parametrosUrl = ['IdDesde', 'IdHasta', 'IdRegistro', 'Cultura', 'Nombre', 'Descripcion'];
				var _filtro = {};
				...
				ko.applyBindings({ Parametros: _parametros }, $('#Foto_IdiomaEditorPrincipalContenedorExterno')[0]);
