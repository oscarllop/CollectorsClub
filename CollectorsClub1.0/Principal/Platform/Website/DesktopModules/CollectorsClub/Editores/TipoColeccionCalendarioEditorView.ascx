<%@ control language="C#" inherits="CollectorsClub.Modules.Editores.EditorTipoColeccionCalendario.View" autoeventwireup="true" codefile="TipoColeccionCalendarioEditorView.ascx.cs" enableviewstate="false" %>
<asp:panel runat="server" id="Container">
	...
	<div id="TipoColeccionCalendarioEditorPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="TipoColeccionCalendarioEditorPrincipalContenedorExterno"></div>
	<div id="TipoColeccionCalendarioEditorPrincipalContenedorExterno" style="display: block;" data-bind="partial: Parametros"></div>
	<script type="text/javascript">
		if (typeof window.ParametrosGlobales === 'undefined') {
			window.ParametrosGlobales = {
				MostrarErrores: true,
				ErrorContainer: 'ErrorContainer',
				//ContenedorModulo: 'TipoColeccionCalendarioEditorPrincipalContenedorExterno',
				//ElementoReferenciaCargando: 'TipoColeccionCalendarioEditorPrincipalContenedorExterno',
				//CapaBloqueoCargando: 'TipoColeccionCalendarioEditorPrincipalContenedorCargando',
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'TipoColeccionCalendarioEditor',
					Entidad: 'TipoColeccionCalendario',
					IdPartial: 'TipoColeccionCalendarioEditorPrincipal',
					Contenedor: '#TipoColeccionCalendarioEditorPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				var _parametrosUrl = ['IdDesde', 'IdHasta', 'Nombre', 'Codigo', 'Cultura', 'IdMarca'];
				var _filtro = {};
				...
				ko.applyBindings({ Parametros: _parametros }, $('#TipoColeccionCalendarioEditorPrincipalContenedorExterno')[0]);
