<%@ control language="C#" inherits="CollectorsClub.Modules.Editores.EditorCalendario_Idioma.View" autoeventwireup="true" codefile="Calendario_IdiomaEditorView.ascx.cs" enableviewstate="false" %>
<asp:panel runat="server" id="Container">
	...
	<div id="Calendario_IdiomaEditorPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="Calendario_IdiomaEditorPrincipalContenedorExterno"></div>
	<div id="Calendario_IdiomaEditorPrincipalContenedorExterno" style="display: block;" data-bind="partial: Parametros"></div>
	<script type="text/javascript">
		if (typeof window.ParametrosGlobales === 'undefined') {
			window.ParametrosGlobales = {
				MostrarErrores: true,
				ErrorContainer: 'ErrorContainer',
				//ContenedorModulo: 'Calendario_IdiomaEditorPrincipalContenedorExterno',
				//ElementoReferenciaCargando: 'Calendario_IdiomaEditorPrincipalContenedorExterno',
				//CapaBloqueoCargando: 'Calendario_IdiomaEditorPrincipalContenedorCargando',
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'Calendario_IdiomaEditor',
					Entidad: 'Calendario_Idioma',
					IdPartial: 'Calendario_IdiomaEditorPrincipal',
					Contenedor: '#Calendario_IdiomaEditorPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				var _parametrosUrl = ['IdDesde', 'IdHasta', 'IdRegistro', 'Cultura', 'Nombre', 'Variante'];
				var _filtro = {};
				...
				ko.applyBindings({ Parametros: _parametros }, $('#Calendario_IdiomaEditorPrincipalContenedorExterno')[0]);
