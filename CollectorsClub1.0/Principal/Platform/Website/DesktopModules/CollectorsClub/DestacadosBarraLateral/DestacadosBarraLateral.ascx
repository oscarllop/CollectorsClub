<%@ Control Language="C#" AutoEventWireup="true" Inherits="CollectorsClub.UI.Skins.Controls.DestacadosBarraLateral" CodeFile="DestacadosBarraLateral.ascx.cs" %>
<asp:panel runat="server" id="Container">
	...
	<div id="DestacadosBarraLateralPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="DestacadosBarraLateralPrincipalContenedorExterno"></div>
	<div id="DestacadosBarraLateralPrincipalContenedorExterno" style="display: block;" data-bind="partialbieniniciada: Parametros"></div>
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'DestacadosBarraLateral',
					//Entidad: 'Empresa', //OLL: Tenemos dos entidades en este módulo, funcionará?
					IdPartial: 'DestacadosBarraLateralPrincipal',
					Contenedor: '#DestacadosBarraLateralPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				var _parametrosUrl = ['IdDesde', 'IdHasta', 'OrdenDesde', 'OrdenHasta', 'IdTipo', 'Activa', 'Nombre', 'IdPais', 'IdTipoPatrocinador', 'IdSalon', 'Ciudad', 'PaginaWeb', 'Descripcion', 'NombreArchivoImagen', 'FechaAltaDesde', 'FechaAltaHasta', 'FechaUltimaModificacionDesde', 'FechaUltimaModificacionHasta', 'Cultura', 'IdMarca'];
				var _filtro = {};
				...
				ko.applyBindings({ Parametros: _parametros }, $('#DestacadosBarraLateralPrincipalContenedorExterno')[0]);
