<%@ Control Language="C#" AutoEventWireup="true" Inherits="CollectorsClub.UI.Skins.Controls.SolicitudContacto" CodeFile="SolicitudContacto.ascx.cs" %>
<asp:panel runat="server" id="Container">
	...
	<div id="SolicitudContactoPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="SolicitudContactoPrincipalContenedorExterno"></div>
	<div id="SolicitudContactoPrincipalContenedorExterno" style="display: block;" data-bind="partialbieniniciada: Parametros"></div>
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'SolicitudContacto',
					Entidad: 'SolicitudContacto',
					IdPartial: 'SolicitudContactoPrincipal',
					Contenedor: '#SolicitudContactoPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				var _parametrosUrl = ['IdDesde', 'IdHasta', 'Nombre', 'Asunto', 'Contenido', 'FechaAltaDesde', 'FechaAltaHasta', 'FechaUltimaModificacionDesde', 'FechaUltimaModificacionHasta', 'IdMarca', 'CorreoElectronico'];
				var _filtro = {};
				...
				_parametros.Modo = (_parametroModo != '' ? _parametroModo : 'Defecto');

				ko.applyBindings({ Parametros: _parametros }, $('#SolicitudContactoPrincipalContenedorExterno')[0]);
