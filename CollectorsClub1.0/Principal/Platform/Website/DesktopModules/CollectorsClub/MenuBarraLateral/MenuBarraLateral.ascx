<%@ Control Language="C#" AutoEventWireup="true" Inherits="CollectorsClub.UI.Skins.Controls.MenuBarraLateral" CodeFile="MenuBarraLateral.ascx.cs" %>
<asp:panel runat="server" id="Container">
	...
	<div id="MenuBarraLateralPrincipalContenedorCargando" class="ContenedorCargando" style="height: 50px; width: 50px;" data-elementoReferencia="MenuBarraLateralPrincipalContenedorExterno"></div>
	<div id="MenuBarraLateralPrincipalContenedorExterno" style="display: block;" data-bind="partialbieniniciada: Parametros"></div>
	<script type="text/javascript">
		if (typeof window.ParametrosGlobales === 'undefined') {
			window.ParametrosGlobales = {
				...
				TabInfo: { ParentId: <%= PortalSettings.ActiveTab.ParentId %>, TabId: <%= PortalSettings.ActiveTab.TabID %>, TabName: '<%= PortalSettings.ActiveTab.TabName %>', Title: '<%= PortalSettings.ActiveTab.Title %>' }
			}
		...
		require(['ParametrosGlobales', 'use!porto/Resources/Menu/menu.min', 'knockout', 'Globales/knockout.extensions', 'dojox/json/ref', 'Globales/Cargando', 'WebAPI/knockout.mapping-latest', 'jquery', 'Globales/Error', 'DNN/dnn.modalpopup', 'Globales/popup', 'Globales/Core.DoubleScroll', 'Globales/Core.ExpandToParent', 'Globales/Core.Utils', 'Plugins/inputmask/inputmask', 'Plugins/inputmask/jquery.inputmask', 'Plugins/inputmask/inputmask.regex.extensions', 'Plugins/inputmask/inputmask.phone.extensions', 'Globales/partials'], function (parametrosGlobales, menu, ko, koextensions, dojoref, cargando, mapping, $, error, modalPopup, popup, doubleScroll, expandToParent, utils, inputmask, jqueryInputmask, inputmaskRegexExtension, inputmaskPhoneExtension, partials) {
			...
			try {
				var _parametros = {
					...
					IdModulo: 'MenuBarraLateral',
					Entidad: 'PaginaGestorContenidos',
					IdPartial: 'MenuBarraLateralPrincipal',
					Contenedor: '#MenuBarraLateralPrincipalContenedorInterno',
					TamanyoPagina: 50,
					ColumnaOrden: 'Id',
					TipoOrden: 0,
				...
				var _parametrosUrl = ['IdDesde', 'IdHasta'];
				var _filtro = {};
				...
				ko.applyBindings({ Parametros: _parametros }, $('#MenuBarraLateralPrincipalContenedorExterno')[0]);
