define(['Globales/BaseViewModelEditor', 'knockout', 'global/knockout/knockout.validation.min', 'Globales/ko.observableDictionary', 'WebAPI/Controllers/TipoColeccionCalendario_IdiomaController', 'WebAPI/Models/TipoColeccionCalendario_IdiomaModel', 'WebAPI/Controllers/TipoColeccionCalendarioController', 'WebAPI/Models/TipoColeccionCalendarioModel', 'Globales/Core.Utils', 'Globales/popup', 'moment/moment-with-locales.min'], function (baseViewModel, ko, validation, observableDictionary, TipoColeccionCalendario_IdiomaController, TipoColeccionCalendario_IdiomaModel, TipoColeccionCalendarioController, TipoColeccionCalendarioModel, utils, popup, moment) {
	try {
		return function TipoColeccionCalendario_IdiomaEditorViewModel(settings) {
			var self = this;
			self.settings = $.extend({}, settings);
			// #region Propiedades y métodos que difieren por entidad
			self.Entidad = 'TipoColeccionCalendario_Idioma';
			...
			self.EntidadesRelacionadas = ['TipoColeccionCalendario'];
			...
			self.MetodoObtenerPorFiltros = 'TipoColeccionCalendario_Idioma_ObtenerPorFiltros';
			self.MetodoObtenerCantidadPorFiltros = 'TipoColeccionCalendario_Idioma_ObtenerCantidadPorFiltros';
			...
			self.New = function () { baseViewModel.New(self, TipoColeccionCalendario_IdiomaModel); };
			...
			self.Inicializar = function (settings) { baseViewModel.Inicializar(self, settings, TipoColeccionCalendario_IdiomaModel); };
			...
			self.MostrarDialogoCopia = function (viewModel) { baseViewModel.MostrarDialogoCopia(viewModel, TipoColeccionCalendario_IdiomaModel); };
			...
			self.MostrarDialogoEdicionMultiple = function (viewModel) { baseViewModel.MostrarDialogoEdicionMultiple(viewModel, TipoColeccionCalendario_IdiomaModel); };
			...
			if (typeof (GlobalControllers) != 'undefined' && typeof (GlobalControllers['TipoColeccionCalendario_IdiomaController']) == 'undefined') { GlobalControllers['TipoColeccionCalendario_IdiomaController'] = new TipoColeccionCalendario_IdiomaController(settings); }
			...
			baseViewModel.InicializarViewModel(self, settings, TipoColeccionCalendario_IdiomaModel);
		};
	} catch (excepcion) {
