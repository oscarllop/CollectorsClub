define(['Globales/BaseViewModelEditor', 'knockout', 'global/knockout/knockout.validation.min', 'Globales/ko.observableDictionary', 'WebAPI/Controllers/Foto_IdiomaController', 'WebAPI/Models/Foto_IdiomaModel', 'WebAPI/Controllers/FotoController', 'WebAPI/Models/FotoModel', 'Globales/Core.Utils', 'Globales/popup', 'moment/moment-with-locales.min'], function (baseViewModel, ko, validation, observableDictionary, Foto_IdiomaController, Foto_IdiomaModel, FotoController, FotoModel, utils, popup, moment) {
	try {
		return function Foto_IdiomaEditorViewModel(settings) {
			var self = this;
			self.settings = $.extend({}, settings);
			// #region Propiedades y métodos que difieren por entidad
			self.Entidad = 'Foto_Idioma';
			self.CamposVisiblesInsercion = { Id: true, IdRegistro: true, Cultura: true, Nombre: true, Descripcion: true };
			self.CamposVisiblesEdicion = { Id: true, IdRegistro: true, Cultura: true, Nombre: true, Descripcion: true };
			self.CamposHabilitadosInsercion = { Id: false, IdRegistro: true, Cultura: true, Nombre: true, Descripcion: true };
			self.CamposHabilitadosEdicion = { Id: false, IdRegistro: true, Cultura: true, Nombre: true, Descripcion: true };
			self.CamposHabilitadosFiltro = { Id: true, IdRegistro: true, Cultura: true, Nombre: true, Descripcion: true };
			...
			self.EntidadesRelacionadas = ['Foto'];
			...
			self.MetodoObtenerPorFiltros = 'Foto_Idioma_ObtenerPorFiltros';
			self.MetodoObtenerCantidadPorFiltros = 'Foto_Idioma_ObtenerCantidadPorFiltros';
			...
			self.New = function () { baseViewModel.New(self, Foto_IdiomaModel); };
			...
			self.Inicializar = function (settings) { baseViewModel.Inicializar(self, settings, Foto_IdiomaModel); };
			...
			self.MostrarDialogoCopia = function (viewModel) { baseViewModel.MostrarDialogoCopia(viewModel, Foto_IdiomaModel); };
			...
			self.MostrarDialogoEdicionMultiple = function (viewModel) { baseViewModel.MostrarDialogoEdicionMultiple(viewModel, Foto_IdiomaModel); };
			...
			if (typeof (GlobalControllers) != 'undefined' && typeof (GlobalControllers['Foto_IdiomaController']) == 'undefined') { GlobalControllers['Foto_IdiomaController'] = new Foto_IdiomaController(settings); }
			...
			self.Fotos = ko.lazyObservableArray(GlobalControllers['FotoController'].GetQuery, self, {
				Todos: true,
				Parameters: 'query=Foto_ObtenerComboPorIdMarca' +
			...
			baseViewModel.InicializarViewModel(self, settings, Foto_IdiomaModel);
		};
	} catch (excepcion) {
