define(['Globales/BaseSystem', 'Globales/Core.Utils', 'partials/Foto_IdiomaEditorViewModel', 'use!porto/js/skin', 'ParametrosGlobales', 'dojo/order!Plugins/ckeditor/ckeditor'], function (baseSystem, utils, viewModel, skin, parametrosGlobales, ckeditor) {
	try {
		return function Foto_IdiomaEditorSystem($, ko, settings) {
			var self = this;
			...
			self.Repositorio = {};
			self.ViewModel;
			self.RutaRecursos = self.settings.ApplicationPath + '/DesktopModules/_extension/Recursos.aspx?Ruta=DesktopModules__CollectorsClub__Editores__App_LocalResources&Modulo=Foto_IdiomaEditorView';
