define(['Globales/BaseViewModelEditor', 'knockout', 'global/knockout/knockout.validation.min', 'Globales/ko.observableDictionary', 'WebAPI/Controllers/SubcategoriaCalendario_IdiomaController', 'WebAPI/Models/SubcategoriaCalendario_IdiomaModel', 'WebAPI/Controllers/SubcategoriaCalendarioController', 'WebAPI/Models/SubcategoriaCalendarioModel', 'Globales/Core.Utils', 'Globales/popup', 'moment/moment-with-locales.min'], function (baseViewModel, ko, validation, observableDictionary, SubcategoriaCalendario_IdiomaController, SubcategoriaCalendario_IdiomaModel, SubcategoriaCalendarioController, SubcategoriaCalendarioModel, utils, popup, moment) {
	try {
		return function SubcategoriaCalendario_IdiomaEditorViewModel(settings) {
			var self = this;
			self.settings = $.extend({}, settings);
			// #region Propiedades y métodos que difieren por entidad
			self.Entidad = 'SubcategoriaCalendario_Idioma';
			...
			self.EntidadesRelacionadas = ['SubcategoriaCalendario'];
			...
			self.MetodoObtenerPorFiltros = 'SubcategoriaCalendario_Idioma_ObtenerPorFiltros';
			self.MetodoObtenerCantidadPorFiltros = 'SubcategoriaCalendario_Idioma_ObtenerCantidadPorFiltros';
			...
			self.New = function () { baseViewModel.New(self, SubcategoriaCalendario_IdiomaModel); };
			...
			self.Inicializar = function (settings) { baseViewModel.Inicializar(self, settings, SubcategoriaCalendario_IdiomaModel); };
			...
			self.MostrarDialogoCopia = function (viewModel) { baseViewModel.MostrarDialogoCopia(viewModel, SubcategoriaCalendario_IdiomaModel); };
			...
			self.MostrarDialogoEdicionMultiple = function (viewModel) { baseViewModel.MostrarDialogoEdicionMultiple(viewModel, SubcategoriaCalendario_IdiomaModel); };
			...
			if (typeof (GlobalControllers) != 'undefined' && typeof (GlobalControllers['SubcategoriaCalendario_IdiomaController']) == 'undefined') { GlobalControllers['SubcategoriaCalendario_IdiomaController'] = new SubcategoriaCalendario_IdiomaController(settings); }
			...
			baseViewModel.InicializarViewModel(self, settings, SubcategoriaCalendario_IdiomaModel);
		};
	} catch (excepcion) {
