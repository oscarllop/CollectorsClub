define(['Globales/BaseViewModelEditor', 'knockout', 'global/knockout/knockout.validation.min', 'Globales/ko.observableDictionary', 'WebAPI/Controllers/SubcategoriaCalendarioController', 'WebAPI/Models/SubcategoriaCalendarioModel', 'WebAPI/Controllers/CategoriaCalendarioController', 'WebAPI/Models/CategoriaCalendarioModel', 'WebAPI/Controllers/MarcaController', 'WebAPI/Models/MarcaModel', 'Globales/Core.Utils', 'Globales/popup', 'moment/moment-with-locales.min'], function (baseViewModel, ko, validation, observableDictionary, SubcategoriaCalendarioController, SubcategoriaCalendarioModel, CategoriaCalendarioController, CategoriaCalendarioModel, MarcaController, MarcaModel, utils, popup, moment) {
	try {
		return function SubcategoriaCalendarioEditorViewModel(settings) {
			var self = this;
			self.settings = $.extend({ Multiidioma: true }, settings);
			// #region Propiedades y métodos que difieren por entidad
			self.Entidad = 'SubcategoriaCalendario';
			self.CamposVisiblesInsercion = { Id: true, IdCategoria: true, Nombre: true, Codigo: true };
			self.CamposVisiblesEdicion = { Id: true, IdCategoria: true, Nombre: true, Codigo: true };
			self.CamposHabilitadosInsercion = { Id: false, IdCategoria: true, Nombre: true, Codigo: true };
			self.CamposHabilitadosEdicion = { Id: false, IdCategoria: true, Nombre: true, Codigo: true };
			self.CamposHabilitadosFiltro = { Id: true, IdCategoria: true, Nombre: true, Codigo: true, Cultura: false, IdMarca: true };
			...
			self.EntidadesRelacionadas = ['CategoriaCalendario', 'Marca'];
			...
			self.MetodoObtenerPorFiltros = 'SubcategoriaCalendario_ObtenerPorFiltros';
			self.MetodoObtenerCantidadPorFiltros = 'SubcategoriaCalendario_ObtenerCantidadPorFiltros';
			...
			self.New = function () { baseViewModel.New(self, SubcategoriaCalendarioModel); };
			...
			self.Inicializar = function (settings) { baseViewModel.Inicializar(self, settings, SubcategoriaCalendarioModel); };
			...
			self.MostrarDialogoCopia = function (viewModel) { baseViewModel.MostrarDialogoCopia(viewModel, SubcategoriaCalendarioModel); };
			...
			self.MostrarDialogoEdicionMultiple = function (viewModel) { baseViewModel.MostrarDialogoEdicionMultiple(viewModel, SubcategoriaCalendarioModel); };
			...
			if (typeof (GlobalControllers) != 'undefined' && typeof (GlobalControllers['SubcategoriaCalendarioController']) == 'undefined') { GlobalControllers['SubcategoriaCalendarioController'] = new SubcategoriaCalendarioController(settings); }
			...
			baseViewModel.InicializarViewModel(self, settings, SubcategoriaCalendarioModel);
		};
	} catch (excepcion) {
