define(['Globales/BaseViewModelEditor', 'knockout', 'global/knockout/knockout.validation.min', 'Globales/ko.observableDictionary', 'WebAPI/Controllers/EstadoCalendario_IdiomaController', 'WebAPI/Models/EstadoCalendario_IdiomaModel', 'WebAPI/Controllers/EstadoCalendarioController', 'WebAPI/Models/EstadoCalendarioModel', 'Globales/Core.Utils', 'Globales/popup', 'moment/moment-with-locales.min'], function (baseViewModel, ko, validation, observableDictionary, EstadoCalendario_IdiomaController, EstadoCalendario_IdiomaModel, EstadoCalendarioController, EstadoCalendarioModel, utils, popup, moment) {
	try {
		return function EstadoCalendario_IdiomaEditorViewModel(settings) {
			var self = this;
			self.settings = $.extend({}, settings);
			// #region Propiedades y métodos que difieren por entidad
			self.Entidad = 'EstadoCalendario_Idioma';
			...
			self.EntidadesRelacionadas = ['EstadoCalendario'];
			...
			self.MetodoObtenerPorFiltros = 'EstadoCalendario_Idioma_ObtenerPorFiltros';
			self.MetodoObtenerCantidadPorFiltros = 'EstadoCalendario_Idioma_ObtenerCantidadPorFiltros';
			...
			self.New = function () { baseViewModel.New(self, EstadoCalendario_IdiomaModel); };
			...
			self.Inicializar = function (settings) { baseViewModel.Inicializar(self, settings, EstadoCalendario_IdiomaModel); };
			...
			self.MostrarDialogoCopia = function (viewModel) { baseViewModel.MostrarDialogoCopia(viewModel, EstadoCalendario_IdiomaModel); };
			...
			self.MostrarDialogoEdicionMultiple = function (viewModel) { baseViewModel.MostrarDialogoEdicionMultiple(viewModel, EstadoCalendario_IdiomaModel); };
			...
			if (typeof (GlobalControllers) != 'undefined' && typeof (GlobalControllers['EstadoCalendario_IdiomaController']) == 'undefined') { GlobalControllers['EstadoCalendario_IdiomaController'] = new EstadoCalendario_IdiomaController(settings); }
			...
			baseViewModel.InicializarViewModel(self, settings, EstadoCalendario_IdiomaModel);
		};
	} catch (excepcion) {
