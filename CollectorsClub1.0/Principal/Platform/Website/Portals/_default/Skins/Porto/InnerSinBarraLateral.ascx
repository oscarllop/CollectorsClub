<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InnerRevisado.ascx.cs" Inherits="Mandeeps.DNN.Skins.Porto.Inner" %>
	...
	<div role="main" class="main">
		<section class="page-top basic">
			<div class="page-top-info container">
				<div class="row">
					<div class="col-md-12">
						<div id="BarraSuperiorPane" runat="server">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9">
					<asp:PlaceHolder ID="pcBreadcrumb" runat="server" Visible="true">
						<div class="row">
							<div class="col-md-12">
								<ul class="breadcrumb">
									<li>
										<dnn:BREADCRUMB ID="BREADCRUMB1" runat="server" CssClass=" " RootLevel="0" Separator=" / " />
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div id="TopLeftDownLeftSidebarOuter" runat="server">
							</div>
						</div>
						<div class="col-md-6">
							<div id="TopLeftDownRightSidebarOuter" runat="server">
							</div>
						</div>
					</div>
				</div>
		...
		<div id="MiddlePaneFull" runat="server">
		</div>
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div id="MiddlePane" runat="server">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-3">
					<div id="LeftShortPane" runat="server">
					</div>
				</div>
				<div class="col-md-6">
					<div id="CenterPane" runat="server">
					</div>
				</div>
				<div class="col-md-3">
					<div id="RightShortPane" runat="server">
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div id="BottomCenterPane" runat="server">
					</div>
				</div>
				<div class="col-md-4">
	...
	<footer id="footer">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div id="FooterCenterPane" runat="server">
					</div>
				</div>
				<div class="col-md-4">
...
<dnn:DnnCssInclude runat="server" FilePath="Inner.theme.css" PathNameAlias="SkinPath" Priority="100" ForceProvider="DnnPageHeaderProvider" />
<!-- Se carga con el use.config como skin.js -->
<%--<dnn:DnnJsInclude runat="server" FilePath="InnerRevisado.js" PathNameAlias="SkinPath" Priority="101" ForceProvider="DnnFormBottomProvider" />--%>
<dnn:DnnCssInclude ID="DnnCssInclude6" runat="server" FilePath="~/js/AMD/plugins/extruder/css/mbExtruder.css" Priority="101" />
<%--<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDRe9Auu84IsLUhinIhQARG5m8ADRnvoxg" type="text/javascript"></script>--%>