<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Inner.ascx.cs" Inherits="Mandeeps.DNN.Skins.Porto.Inner" %>
...
<dnn:DnnJsInclude runat="server" FilePath="Inner.js" PathNameAlias="SkinPath" Priority="101" ForceProvider="DnnFormBottomProvider" />
