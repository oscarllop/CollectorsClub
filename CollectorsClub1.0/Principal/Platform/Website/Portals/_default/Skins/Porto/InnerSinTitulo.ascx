<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InnerSinTitulo.ascx.cs" Inherits="Mandeeps.DNN.Skins.Porto.Inner" %>
			...
			<div class="container">
				...
				<div class="social-icons">
					<ul class="social-icons">
						...
						<li class="facebook active"><a href="https://www.facebook.com/pages/CollectorsClub/" target="_blank" title="Facebook"></a></li>
