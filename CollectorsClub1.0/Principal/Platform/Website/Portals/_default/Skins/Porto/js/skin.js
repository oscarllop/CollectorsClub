		...
		StickyMenu: {
			...
			build: function () {
				...
				var self = this,
					...
					// OLL: Modificaciones header
					$PatrocinadoresPrincipales = $header.find('.PatrocinadoresPrincipales'),
					$InformacionEdicion = $header.find('.InformacionEdicion'),
				...
				self.stickyMenuActivate = function () {
					...
					$PatrocinadoresPrincipales.addClass('sticky-menu-active');
					$InformacionEdicion.addClass('sticky-menu-active');
				...
				self.stickyMenuDeactivate = function () {
					...
					if ($body.hasClass('sticky-menu-active')) {
						...
						$PatrocinadoresPrincipales.removeClass('sticky-menu-active');
						$InformacionEdicion.removeClass('sticky-menu-active');
